...
def build_country_dictionary(category_filename):
    dictionary = {}
    with open(category_filename) as csv_file:
        csv_reader = csv.reader(csv_file, delimiter=',')
        line_count = 0
...
def build_url(params, access_token, ad_id):
    url_list = []
    for param in params:
        URL = "https://graph.facebook.com/v3.2/act_554494337998790" + \
              "/delivery_estimate?access_token=EAAEj9sPjQ8QBABFc9MgbRw7ZCutB5q8JS7CBnvj9WG7qa0JEJGx98gWo28dsN79C1hJWT2Yi2OoKeyMqC76qwIW9weJKg5Gv9w0h6pAiZB3ieQQDK1pYMtGOL3wikmraCgTvuF02jtdi34MJwA7O6QlVHWhe4ntPFWlmr4UemxZBOJGnzD3" + \
